    ...
    <div class="main-content">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(str_replace('_', ' ', $order->payment_method)); ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('customer.order-detail', $order->id)); ?>"
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <h4>No Orders</h4>
                <a href="<?php echo e(route('customer.products')); ?>" class="btn btn-success mt-3">Start Shoopping</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH C:\laragon\www\projectrey\resources\views/customer/orders.blade.php ENDPATH**/ ?>